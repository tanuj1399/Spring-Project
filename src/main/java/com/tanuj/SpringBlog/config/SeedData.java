...
import com.tanuj.SpringBlog.services.AuthorityService;
...
public class SeedData implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception{
        ...
        for(Privileges auth: Privileges.values()){
            ...
            authority.setName(auth.getPrivileges());
       ...
       account01.setAge(22);
       account01.setDate_of_birth(LocalDate.parse("1998-02-04"));
       ...
       account02.setAge(34);
       account02.setDate_of_birth(LocalDate.parse("1995-06-12"));
       ...
       account03.setAge(46);
       account03.setDate_of_birth(LocalDate.parse("1988-02-17"));
       ...
       account04.setAge(39);
       account04.setDate_of_birth(LocalDate.parse("1991-11-10"));
       account04.setGender("Female");

       account05.setEmail("tanujdemo@gmail.com");
       account05.setPassword("pass987");
       account05.setFirstname("Tanuj");
       account05.setLastname("Singh");
       account05.setAge(24);
       account05.setDate_of_birth(LocalDate.parse("1999-09-13"));
